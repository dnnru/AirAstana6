<%@ Control Language="C#" CodeBehind="NomadClubLogin.ascx.cs" Inherits="AirAstana.Themes.AirAstana6.SkinObjects.NomadClubLogin" %>
    ...
    <asp:Panel runat="server" ID="LogoutPanel" CssClass="m-4">
        <div class="mb-3">
            <a href="<%= Utils.ConstructCurrentUrl(Localization.GetString("ManageAccount.Url", LocalResourceFile)) %>" class="text-reset text-decoration-none">
                <div class="row">
                    <div class="col-2">
                        <img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/i-user.svg" alt="">
                    </div>
                    <div class="col-8">
                        <h5>
                    ...
                    <div class="col-2 text-right">
                        <img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/chevron-large-right.svg" alt="">
                    </div>
                </div>
            </a>
            <hr />
        ...
        <div runat="server" id="CoporateRow" class="mb-3">
            <a href="<%= Utils.ConstructCurrentUrl(Localization.GetString("CorporateAccount.Url", LocalResourceFile)) %>" class="text-reset text-decoration-none">
                <div class="row">
                    <div class="col-2">
                        <img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/i-corp.svg" alt="">
                    </div>
                    <div class="col-8">
                        <h5>
