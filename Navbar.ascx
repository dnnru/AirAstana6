...
<%@ Import Namespace="AirAstana.Themes.AirAstana6.Components" %>
...
<script runat="server">
    private const string LocalResourceFile = "/Portals/_default/Skins/AirAstana6/App_LocalResources/Navbar.ascx";
</script>
    ...
    <div class="container-fluid aa-main-menu">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed" data-toggle="modal" data-target="#aa-navigation-mobile-modal">
                <img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/menu.svg" alt="">
            </button>
            <% if (NomadSessionUtil.IsAuthenticated())
               { %>
                <a class="navbar-toggle collapsed aa-user-login" href="#" data-toggle="modal" data-target="#aa-login-mobile-modal">
                    <img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/user-logged-in.svg" alt="">
                </a>
            <% }
               else
               { %>
                <a class="navbar-toggle collapsed aa-user-login" href="<%= Utils.ConstructCurrentUrl(Localization.GetString("ManageAccount.Url", LocalResourceFile)) %>">
                    <img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/user.svg" alt="">
                </a>
            <% } %>
            <button type="button" id="aa-language-mobile-button" class="navbar-toggle collapsed" data-region="<%= PortalSettings.Current.PortalId %>" data-toggle="modal" data-target="#aa-language-mobile-modal">
                <img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/globe.svg" alt="">
            </button>
            <a class="brand logo-big" href="<%= Utils.GetHomeTabUrl(PortalSettings.Current) %>">
                <img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/logo-full.svg" alt="Air Astana">
            </a>
            <a class="brand logo-small" href="<%= Utils.GetHomeTabUrl(PortalSettings.Current) %>">
                <img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/logo-mini.svg" alt="Air Astana">
            </a>
        </div>
        <div class="collapse navbar-collapse" id="aa-navbar">
            <ddr:menu ID="navigationMenu" MenuStyle="AirAstanaMenu" runat="server" NodeManipulator="AirAstana.Themes.AirAstana6.Components.NodeManipulator, AirAstana.Themes.AirAstana6"></ddr:menu>
            <ul class="nav navbar-nav navbar-right aa-navbar-controls navbar-hide-small">
                <li id="search-input-form">
                    <a id="search-input-anchor" href="#" data-target="#aa-search-modal" data-toggle="modal">
                        <img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/search.svg" alt="">
                    </a>
                </li>
                ...
                <div class="input-group">
                    <span class="input-group-btn">
                        <button class="btn btn-default" id="executeSearch">
                            <img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/search.svg" alt="<%= Localization.GetString("Search.Text", LocalResourceFile) %>">
                        </button>
                    </span>
                    ...
                    <span class="input-group-btn">
                        <button type="button" class="btn btn-default" data-dismiss="modal" aria-label="Close">
                            <img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/close-small.svg" alt="">
                        </button>
                    </span>
                </div>
                <%--
                ...
                <div class="clearfix">
                    <div class="pull-left">
                        <a href="#" onclick="showNavigationMobileModal();">
                            <img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/chevron-large-left.svg" alt="">
                        </a>
                    </div>
                    <div class="pull-right">
                        <a href="#" data-dismiss="modal" aria-label="Close">
...
<img src="<%= AirAstana.Themes.AirAstana6.Components.Constants.SKIN_PATH %>/svg/globe.svg" alt="" class="mr-3"><span>{{= region.PortalName }}</span>
</div>
...
var ADDITIONAL_NODE_MOBILE_FIRST = "<%= AirAstana.Themes.AirAstana6.Components.Constants.ADDITIONAL_NODE_MOBILE_FIRST %>";
var ADDITIONAL_NODE = "<%= AirAstana.Themes.AirAstana6.Components.Constants.ADDITIONAL_NODE %>";
